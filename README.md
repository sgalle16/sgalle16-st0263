...
Se plantea implementar un sistema p2p totalmente descentralizado y no estructurado, usando protocolos de comunicación entre peers, api rest, grpc y mom con RabbitMQ
